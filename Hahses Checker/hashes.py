...
async def main(api_key, file_hashes_path, output_file_path, mal_output_file_path):
    ...
    if md5_hashes:
        ...
        with open('MD5_Converted_to_SHA256.txt', 'w') as converted_file:
...
file_hashes_path = 'hashes.txt'  # Replace with the path to your file of hashes
output_file_path = 'scan_results.txt'  # Path to the output file where results will be saved
mal_output_file_path = 'malicious_hashes.txt'  # Path to the output file for malicious hashes
